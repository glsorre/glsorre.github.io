...
1. Engineered the Vendor Portal, a tool to create and deploy third-party apps for Acronis platform, MVP in 6 months and subsequently
scaled it by adding key features and reusable components to Acronis design system, using **Vue.js ecosystem, TDD, GitHub Copilot and REST APIs**
